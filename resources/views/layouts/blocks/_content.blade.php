	...
	<div class="white-bg">
		...
		<div class="product-item-footer">
			<div class="author">
				...
				<a class="user_name" href="{{ route('profile.index', ['slug' => $product->user->slug]) }}">{{ $product->user->name }}</a>
				<ul class="coccoc-product-item-btn list-inline pull-right">
					<li>
						<a href=""><i class="fa fa-comment"></i> 6</a>
					</li>
					{{--  <li><a href="" class="btn btn-default btn-xs disabled"><i class="fa fa-check"></i> Đã Lưu</a></li>  --}}
